...
def feature_getting(train_loader, train=True):
    ...
    if train is True:
        np.save('feature_set_train.npy', feature_set)
        np.save('label_set_train.npy', label_set)
    else:
        np.save('feature_set_val.npy', feature_set)
        np.save('label_set_val.npy', label_set)
