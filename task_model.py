...
def model_list_train(model_map, feature_set_train, label_set_train, feature_set_val, label_set_val):
    ...
    for model_index in range(len(model_map)):
        Feature_train = Feature_set(feature_set_train, label_set_train, model_map[model_index], Config.map_threshold)
        Feature_val = Feature_set(feature_set_val, label_set_val, model_map[model_index], Config.map_threshold)
