...
from yolo_utils.metric import ap_per_class, ConfusionMatrix
...
if __name__ == '__main__':
    ...
    if opt.task in ('train', 'val', 'test'):  # run normally
        ...
        # python yolo_test.py --task study --data coco.yaml --iou 0.7 --weights yolov5s.pt yolov5m.pt yolov5l.pt yolov5x.pt
